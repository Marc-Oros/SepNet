...
def getClassCombinationsWithPerson(classesInImage):
    if 'person' in classesInImage:
        classCombinations = [('person', clsName) for clsName in classesInImage if clsName != 'person']
    else:
        classCombinations = []
