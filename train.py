...
resume_from_checkpoint = True if '--resume' in sys.argv else False
if resume_from_checkpoint is True:
    print("Resuming from checkpoint")
checkpoint = 'BEST_checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar' if resume_from_checkpoint is True else None  # path to checkpoint, None if none
